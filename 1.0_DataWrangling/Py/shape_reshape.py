""" The shape tool gives a tuple of array dimensions and can be used to change the dimensions 
of an array.
...
# Read space-separated integers from input and convert them to a NumPy array with shape (3, 3)
input_values = input().split()
XNumPy_array = np.array(input_values, dtype=int).reshape(3, 3)
