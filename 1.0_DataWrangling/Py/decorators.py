...
some information about N people. Each person has a first name, 
...
name should be printed first. For two people of the same age, print 
...
itemgetter library. You can read more about it 
[here](https://stackoverflow.com/questions/409370/sorting-and-grouping-nested-lists-in-python?answertab=votes#tab-top). """
